...
class Cs_lec_s12_MainActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cs_lec_s12__main)
        ...
        val progcuri: Uri =
            Uri.parse("https://drive.google.com/drive/folders/1CsN76OOmqcGGa8tWU0gPsM3WhXnKxhPd?usp=sharing")
        val deuri: Uri =
